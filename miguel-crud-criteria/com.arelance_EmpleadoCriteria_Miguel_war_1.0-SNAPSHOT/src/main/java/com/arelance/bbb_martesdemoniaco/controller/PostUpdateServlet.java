...
public class PostUpdateServlet extends HttpServlet {
     ...
     * @throws CampoVacioException si uno de los campos estan vacios,
     * CampoVacioHandler maneja esta excepcion Al final del metodo, se actualiza
     * en el atributo de la sesion la lista desordenada de todos los empleados
     */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Empleado empleado = new Empleado(Integer.parseInt(request.getParameter("id_empleado")));
