 ...
 * @author Miguel
 */
@WebServlet(name = "CampoVacioHandler", urlPatterns = {"/CampoVacioHandler"})
public class CampoVacioHandler extends HttpServlet {
     ...
     * Simplemente manda un mensaje de error en la request y redirige a la pagina apropiada donde haya ocurrido la excepcion, 
     * Dependiendo del Servlet
     */
